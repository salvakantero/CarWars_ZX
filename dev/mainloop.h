...
void main (void) {
...
#if defined(PLAYER_CAN_DRILL)
	sp_hitter = sp_CreateSpr (sp_MASK_SPRITE, 2, sprite_drill0_l, 2, TRANSPARENT);
	sp_AddColSpr (sp_hitter, sprite_drill0_l + 32, TRANSPARENT);
	hitter_current_frame = sprite_drill0_l;
#endif
	...
	while (1) {
		...
		silent_level = 0;
		//level = 0;
		prepare_level (); // llamo aquí para usar la misma fuente que durante el juego
		level = simple_menu ();
		...
		while (mlplaying) {
			...
			if (!silent_level) {
				...
				print_str (9, 9, 71, "!!          !!");
				print_str (9, 10, 71, "!!");
				print_str (12, 10, 66,"STAGE");
				print_number2 (18, 10, level + 1);
				print_str (20, 10, 71, " !!");
				print_str (9, 11, 71, "!!          !!");
				print_str (9, 12, 71, "!!!!!!!!!!!!!!");
				*/
				...
				print_str (9, 11, 71, "!!  ------  !!");
				print_str (9, 12, 71, "!!!!!!!!!!!!!!");
				if (level == 1) print_str (13, 11, 6, "LOU011");		
				if (level == 2) print_str (13, 11, 6, "PAE235");		
...
#if defined(PLAYER_KILLS_ENEMIES) || defined(PLAYER_CAN_FIRE) || defined(PLAYER_CAN_DRILL)
