...
//#define PLAYER_REFILL			20		// Life recharge
...
#define TYPE_6_FIXED_SPRITE 	0		// Sprite used - 1.
#define SIGHT_DISTANCE			72 //96	// Used in our type 6 enemies.
//#define TYPE_6_KILL_ON_TOUCH			// If defined, enemy also dies when collision happens
#define FANTY_MAX_V 			96		//256 	// Flying enemies max speed (also for custom type 6 if you want)
...
#define TYPE_8_SHOOT_FREQ		31		// Shoot frequency (2^n-1)
#define TYPE_8_SAFE_DISTANCE	48		// if closer won't shoot
...
#define TILE_GET_FLAG 		   3		// And this increments flag #
#define PERSISTENT_TILE_GET				// Only works with compressed levels/128K games.
#define LIVE_TILE_GET		   15		// If defined, player can "get" tile # to increment 1 live.
#define PERSISTENT_LIVE_TILE_GET		// Only works with compressed levels/128K games.
#define HELP_TILE_GET		   40		// If defined, player can "get" tile # to obtain related help.
#define TILE_GET_SCRIPT					// Run PLAYER_GETS_COIN when player gets tile HELP_TILE_GET
...
//#define BODY_COUNT_ON			7		// Increment flag # everytime the player kills an enemy. Also when PLAYER_CAN_DRILL
...
//#define PLAYER_CAN_FIRE_FLAG	5		// If defined, player can only fire when flag # is 1
...
#define PLAYER_CAN_DRILL				// Player can drill. (CarWars) Works in MOGGY_STYLE. 
...
//#define BOMBS_EXPLOSION_TILE	16		// Tile # for explosion.
//#define BOMBS_BREAK_WALLS				// If defined, bombs break breakable walls.
//#define PLAYER_BOMBS_TILE		17		// ... You know the drill...
...
//#define AMMO_X				14		//
//#define AMMO_Y				19		// Ammo counter character coordinates
//#define TIMER_X 				1		//
//#define TIMER_Y 				0		// Timer counter coordinates
//#define PLAYER_SHOW_TIMER 			// If defined, show timer counter
#define FLAG_X					21		//
#define FLAG_Y					21		// Custom flag character coordinates
#define PLAYER_SHOW_FLAG		3		// If defined, show flag #
//#define FUEL_X				99		//
...
#define PAUSE_ABORT						// Add x=ABORT, m=MUTE MUSIC ON/OFF
...
#define PLAYER_MAX_VX			256 //256 	// Max velocity (192/64 = 3 p?xels/frame)
#define PLAYER_AX				48	//64	// Acceleration (24/64 = 0,375 p?xels/frame^2)
#define PLAYER_RX				48	//96	// Friction (32/64 = 0,5 p?xels/frame^2)
...
unsigned char behs [] = {
	0, 8, 8, 8, 8, 8, 8, 8, 1, 1, 1, 1, 1, 0,10, 0,
	0, 0, 0, 0, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 1, 8,
